...
var jsSrc = ['app/src/js/angular/angular.js',
			 ...
			 'app/src/js/services/geolocation.js',
			 'app/src/js/services/data.js',
			 'app/src/js/services/map.js',
			 'app/src/js/controllers/index.js',
			 'app/src/js/app.js'];
...
gulp.task('compress:json', function () {
    gulp.src('app/build/assets/data/data.json')
        .pipe($.jsonminify())
        .pipe($.rename('data.min.json'))
        .pipe(gulp.dest('app/build/assets/data'))
        .pipe($.size({title: 'compress:json'}));
});
    
gulp.task('compress:css', function () {
    gulp.src('app/build/assets/css/styles.css')
        .pipe($.csso())
...
gulp.task('compress', ['compress:css', 'compress:js', 'compress:json']);
